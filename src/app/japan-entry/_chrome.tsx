    ...
    <footer className="bg-background">
      <div className="flex w-full flex-col gap-3 px-4 py-8 text-xs text-muted-foreground md:flex-row md:items-center md:justify-between md:px-8">
        ...
        <nav className="flex flex-wrap items-center gap-x-5 gap-y-2">
          ...
          <Link href="/japan-entry/terms" className="transition-colors hover:text-primary-readable">
            Terms
          </Link>
          <Link href="/japan-entry/privacy-policy" className="transition-colors hover:text-primary-readable">
            Privacy
          </Link>
