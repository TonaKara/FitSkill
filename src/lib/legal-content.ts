...
export const TERMS_SECTIONS: readonly LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      `運営者が指定する外部ツール（${ALLOWED_EXTERNAL_TOOLS_LIST}）以外への誘導、およびそれを利用した直接的な金銭の授受`,
  ...
  },
  {
    title: "第7条（外部ツールの利用）",
    body: [
      `利用者は、取引の履行（オンラインレッスン等）にあたり、${ALLOWED_EXTERNAL_TOOLS_LIST} の外部ツールを連携・利用することができます。ただし、当該外部ツールの利用に起因するアカウント停止、接続不良、規約違反等のトラブルについて、運営者は一切の責任を負いません。`,
    ],
  },
  {
    title: "第8条（対面指導に関する注意と自己責任）",
    body: [
      "取引内容に基づき、利用者間で対面による直接指導（フィットネス指導、レッスン等を含みますがこれらに限られません）を行う場合、必ず公共の安全な場所で実施するものとし、夜間・密室など危険を伴う場所での実施を禁止します。",
  ...
  },
  {
    ...
    body: [
      "スキルやコンテンツの提供方法、メッセージや成果物、動画・写真のやり取り等は、当事者間で誠実に合意し履行するものとします。",
  ...
  },
  {
    ...
    body: [
      ...
      "利用者が本サービス内に投稿した動画、画像、テキスト等のコンテンツ（以下「投稿コンテンツ」といいます）の著作権は、当該コンテンツを作成した利用者に帰属します。",
      ...
      "運営者は、利用者のプライバシー保護およびシステムのデータ容量最適化のため、取引完了から一定期間経過後、本サービス上のチャットでやり取りされた画像・動画等の投稿コンテンツを自動的に削除することがあります。利用者は、必要に応じてあらかじめ各自でコンテンツの保存を行うものとし、削除されたことに起因する損害について運営者は一切の責任を負いません。",
    ],
  },
  {
    title: "第11条（決済・手数料）",
  ...
  },
  {
    ...
    body: [
      ...
      "運営者は、Stripe のシステム障害、認証エラー、振込遅延、または決済の取り消し（チャージバック等）により、出品者が報酬を得られなかった場合や、購入者が返金を受けられなかった場合について、いかなる責任も負わないものとします。これらは利用者と Stripe 社、または利用者間での解決を原則とします。",
      "利用者は、提供されるスキル（フィットネスや運動指導等を含みます）を実践する際、自身の健康状態（妊娠、負傷、持病、アレルギー等を含みますが、これらに限られません）を考慮したうえで、自己の責任において本サービスを利用するものとします。",
      "スキルの実践に伴う事故、怪我、体調悪化、その他一切の損害について、運営者は一切の責任を負いません。特に妊娠中の方や加療中の方は、必ず医師の相談を受けたうえで、無理のない範囲で利用してください。",
    ],
  },
  {
