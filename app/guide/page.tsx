...
import { ArrowDown, BadgeCheck, Handshake, ShieldCheck } from "lucide-react"
          ...
          <div key={step.title}>
            ...
            {!isLast ? (
              <div className="flex justify-center py-2">
                <div className="rounded-full border border-red-400/40 bg-red-500/10 p-1.5">
                  <ArrowDown className="h-5 w-5 text-red-300" strokeWidth={2.75} />
                </div>
              </div>
            ) : null}
          </div>
